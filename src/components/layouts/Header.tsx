...
const navigation = [
    ...
    {name: 'Todo', href: 'todos', current: false},
                                ...
                                <div className="hidden sm:block sm:ml-6">
                                    <div className="flex space-x-4">
                                        {navigation.map((item) => (
                                            ...
                                            >
                                                <a className={`px-3 py-2 rounded-md text-sm font-medium text-white`}>{item.name}</a>
                                            </Link>
                                        ))}
                                    </div>
                                </div>
                                            ...
                                            <Menu.Item>
                                                {({active}) => (
                                                    <Link
                                                        href="#"
                                                    >
                                                        <a className={classNames(active ? 'bg-gray-100' : '', 'block px-4 py-2 text-sm text-gray-700')}>test</a>
                                                    </Link>
                                                )}
                                            </Menu.Item>
                                            <Menu.Item>
